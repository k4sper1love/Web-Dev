export interface Product {
  ...
  export const products = [
    ...
    },
    {
      ...
      price: 73,
      description: `страна производства: Санкт-Петербург;
      тип: поваренная соль;
      вид соли: йодированная;
      сорт: высший;
      помол: средний`,
      image: 'https://resources.cdn-kaspi.kz/img/m/p/h3b/hcb/83296490618910.jpg?format=gallery-large',
      rating: 5,
      link: 'https://kaspi.kz/shop/p/araltuz-povarennaja-sol-iodirovannaja-pomol-srednii-1000-g-100218821/?c=750000000',
      inStock: true
    },
    {
      id: 5,
    ...
    {
      id: 7,
      name: 'Добро Строй навес 325412 450х280 см',
      price: 3000000,
      description: `тип: навес;
      материал кровли: металлочерепица;
      цвет: серый;
      ширина, см: 450;
      длина: 280.0 см;`,
      image: 'https://resources.cdn-kaspi.kz/img/m/p/h16/h76/68224757432350.jpg?format=gallery-large',
      rating: 0,
      link: 'https://kaspi.kz/shop/p/dobro-stroi-naves-325412-450h280-sm-108581955/?c=750000000',
      inStock: false
    },
    {
      id: 8,
